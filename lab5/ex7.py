...
measurement_noise = np.sqrt(R_true) * np.random.randn(T)
...
plt.plot(t, estimates[0], label='R = 0.01')
plt.plot(t, estimates[1], label='R = 0.5')
plt.plot(t, estimates[2], label='R = 5')
